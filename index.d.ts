...
export interface SelectDropdownType {
   ...
   */
  renderDropdownIcon?: (selectedItem: DropdownItem, index: number) => React.ReactNode;
  /**
   ...
   */
  renderSearchInputLeftIcon?: (selectedItem: DropdownItem, index: number) => React.ReactNode;
  /**
   * function returns React component for search input icon
   */
...
declare module 'react-native-select-dropdown' {
  export type SelectDropdownProps = SelectDropdownType &
    (
      | {
          /**
      ...
      | {
           ...
           */
          renderCustomizedButtonChild?: (selectedItem: DropdownItem, index: number) => React.ReactNode;
        }
    ) &
    (
      | {
